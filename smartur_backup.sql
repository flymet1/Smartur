...
\restrict SEn0FuaTzQn9WrssOztCPTljWfPagMGLzOWTWwIdZ99itxD88BTCYFleKPMoAA0
...
Kişi Sayısı: {kisiSayisi}'::text,
    ...
    region text,
    tour_languages text DEFAULT '["tr"]'::text,
...
CREATE TABLE public.tenants (
    ...
    website_favicon_url text,
    website_hero_image_url text,
    website_about_text text,
    website_footer_text text,
    website_social_links text DEFAULT '{}'::text,
    website_google_analytics_id text,
    website_whatsapp_number text,
    website_payment_provider text,
    website_payment_api_key text,
    website_payment_secret_key text,
    website_languages text DEFAULT '["tr"]'::text,
    website_contact_page_title text,
    website_contact_page_content text,
    website_contact_email text,
    website_contact_phone text,
    website_contact_address text,
    website_about_page_title text,
    website_about_page_content text,
    website_cancellation_page_title text,
    website_cancellation_page_content text,
    website_privacy_page_title text,
    website_privacy_page_content text,
    website_terms_page_title text,
    website_terms_page_content text,
    website_faq_page_title text,
    website_faq_page_content text,
    website_template_key text DEFAULT 'modern'::text,
    website_template_settings text DEFAULT '{}'::text,
    website_footer_company_description text,
    website_footer_payment_image_url text,
    website_footer_copyright_text text,
    website_footer_background_color text,
    website_footer_text_color text,
    website_header_background_color text,
    website_header_text_color text
);
...
COPY public.activities (id, name, description, price, duration_minutes, active, daily_frequency, default_times, confirmation_message, default_capacity, agency_phone, admin_phone, send_notification_to_agency, send_notification_to_admin, notification_message_template, name_aliases, price_usd, reservation_link, reservation_link_en, has_free_hotel_transfer, transfer_zones, extras, faq, color, tenant_id, shared_with_partners, image_url, gallery_images, region, tour_languages, difficulty, included_items, excluded_items, meeting_point, categories, highlights, min_age, max_participants) FROM stdin;
8	ATV Safari		2000	60	t	3	["09:00","13:00","17:00"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Rezervasyonunuzu takip etmek için: {takip_linki} Teşekkür ederiz.	10	\N	\N	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kişiSayısı}	["atv safari","quad bike"]	30	\N	\N	f	[]	[]	[]	orange	7	t	\N	[]	\N	["tr"]	easy	[]	[]	\N	[]	[]	\N	\N
9	Balon Turu		5000	30	t	1	["09:00"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Rezervasyonunuzu takip etmek için: {takip_linki} Teşekkür ederiz.	10	\N	\N	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kişiSayısı}	["Ballon Tour"]	120	\N	\N	f	[]	[]	[]	blue	9	t	\N	[]	\N	["tr"]	easy	[]	[]	\N	[]	[]	\N	\N
10	Yamaç Paraşütü	Babadağ'dan muhteşem Ölüdeniz manzarasıyla tandem yamaç paraşütü deneyimi. Profesyonel pilotlarımızla güvenli uçuş.	3500	45	t	1	["09:00", "11:00", "14:00", "16:00"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Teşekkür ederiz.	10	\N	\N	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kisiSayisi}	[]	100	\N	\N	f	[]	[]	[]	blue	2	f	https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=800	[]	Fethiye/Ölüdeniz	["tr", "en", "de", "ru"]	moderate	["Sigorta", "Transfer", "HD Video & Fotoğraf", "Sertifika"]	["Yemek", "İçecek"]	Ölüdeniz Beach	["Macera", "Hava Sporları", "Ekstrem"]	["1900m Yükseklikten Uçuş", "Profesyonel Pilotlar", "GoPro Çekim", "Ücretsiz Transfer"]	6	50
11	Tekne Turu - 12 Ada	Fethiye'nin kristal berraklığındaki koylarını keşfedin. 12 ada turu ile yüzme, güneşlenme ve eşsiz doğa.	1200	480	t	1	["09:30"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Teşekkür ederiz.	10	\N	\N	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kisiSayisi}	[]	35	\N	\N	f	[]	[]	[]	blue	2	f	https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800	[]	Fethiye	["tr", "en"]	easy	["Öğle Yemeği", "Sigorta", "Şnorkel Ekipmanı", "Plaj Havlusu"]	["Alkollü İçecek", "Fotoğraf Hizmeti"]	Fethiye Marina	["Deniz", "Doğa", "Yüzme"]	["12 Farklı Koy", "Taze Deniz Yemeği", "Cam Tabanlı Tekne", "DJ Müzik"]	0	100
12	ATV Safari	Fethiye'nin dağlarında heyecan dolu ATV macerası. Profesyonel rehberler eşliğinde doğayla iç içe.	900	120	t	1	["10:00", "14:00", "17:00"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Teşekkür ederiz.	10	\N	\N	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kisiSayisi}	[]	25	\N	\N	f	[]	[]	[]	blue	2	f	https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800	[]	Fethiye	["tr", "en", "ru"]	moderate	["Kask", "Gözlük", "Sigorta", "Su"]	["Fotoğraf", "Video"]	Kayaköy	["Macera", "Safari", "Doğa"]	["Çamur Parkuru", "Dağ Manzarası", "Profesyonel Eğitim"]	16	20
6	at turu		1000	26	t	3	["09:00","13:00","17:00"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Rezervasyonunuzu takip etmek için: {takip_linki} Teşekkür ederiz.	6	\N	323423423	f	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kişiSayısı}	["horse"]	10	https://skyfethiye.com/aktiviteler/fethiye-yamac-parasutu/	https://skyfethiye.com/en/activities/paragliding-fethiye/	t	["hisarönü"]	[{"name":"Fotoğraflar","priceTl":1000,"priceUsd":20,"description":"Opsiyonel"}]	[{"question":"Kaç dakika","answer":"30 dakikalık tur"}]	pink	7	f	\N	[]	\N	["tr"]	easy	[]	[]	\N	[]	[]	\N	\N
7	Tekne Turu	günlük tur 	1000	420	t	1	["09:00"]	\N	10	23423423	234234234	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kişiSayısı}	["Boat Tour"]	20	https://skyfethiye.com/aktiviteler/fethiye-yamac-parasutu/	https://skyfethiye.com/en/activities/paragliding-fethiye/	f	[]	[{"name":"kantin","priceTl":0,"priceUsd":0,"description":""}]	[{"question":"Tekne kaç kişilik","answer":"teknemiz 100 kişiliktir"}]	green	7	f	\N	[]	\N	["tr"]	easy	[]	[]	\N	[]	[]	\N	\N
13	Dalyan Turu	Antik Kaunos şehrini ve Caretta Caretta kaplumbağalarını görün. Çamur banyosu ve termal havuz.	1500	540	t	1	["08:30"]	Sayın {isim}, rezervasyonunuz onaylanmıştır. Tarih: {tarih}, Saat: {saat}. Teşekkür ederiz.	10	\N	\N	t	t	Yeni Rezervasyon:\nMüşteri: {isim}\nTelefon: {telefonunuz}\nEposta: {emailiniz}\nTarih: {tarih}\nSaat: {saat}\nAktivite: {aktivite}\nKişi Sayısı: {kisiSayisi}	[]	45	\N	\N	f	[]	[]	[]	blue	2	f	https://images.unsplash.com/photo-1503220317375-aaad61436b1b?w=800	[]	Dalyan	["tr", "en", "de"]	easy	["Öğle Yemeği", "Çamur Banyosu", "Transfer", "Sigorta", "Tekne Gezisi"]	["Fotoğraf", "İçecek"]	Fethiye Merkez	["Kültür", "Doğa", "Tarih"]	["Kral Mezarları", "Caretta Caretta", "Çamur Banyosu", "İztuzu Plajı"]	0	45
\.
...
COPY public.blog_posts (id, tenant_id, title, slug, excerpt, content, featured_image_url, author, meta_title, meta_description, meta_keywords, status, category, tags, published_at, created_at, updated_at) FROM stdin;
\.
...
10	7	8	2026-01-05	13:00	Test	2334242	2	[Partner: Acenta 2]	deleted	10	10	2026-01-10 07:44:39.139	\N	\N	2026-01-10 07:33:13.718231	receiver_full	0	TRY	\N
...
COPY public.reservations (id, activity_id, customer_name, customer_phone, customer_email, date, "time", quantity, status, source, external_id, created_at, price_tl, price_usd, currency, agency_id, order_subtotal, order_total, order_tax, settlement_id, package_tour_id, parent_reservation_id, order_number, tracking_token, tracking_token_expires_at, hotel_name, has_transfer, tenant_id, payment_status, notes, created_by_user_id) FROM stdin;
57	9	eeeee	55555	\N	2026-01-09	09:00	1	pending	partner	\N	2026-01-10 08:15:55.157341	0	0	TRY	\N	0	0	0	\N	\N	\N	\N	\N	\N	\N	f	9	unpaid	[Partner: acenta]	\N
58	9	rrr	55555	\N	2026-01-11	09:00	1	pending	partner	\N	2026-01-10 08:15:57.421796	0	0	TRY	\N	0	0	0	\N	\N	\N	\N	\N	\N	\N	f	9	unpaid	[Partner: acenta]	\N
59	9	tttt	555555	\N	2026-01-10	09:00	1	pending	partner	\N	2026-01-10 08:15:59.099835	0	0	TRY	\N	0	0	0	\N	\N	\N	\N	\N	\N	\N	f	9	unpaid	[Partner: acenta]	\N
61	7	hamasıs	515126276183232	fsasasasda@hotmail.com	2026-01-31	09:00	1	pending	manual	\N	2026-01-14 14:42:22.56665	0	0	TRY	\N	0	0	0	\N	\N	\N	454333	\N	\N	\N	f	7	unpaid	\N	2
\.
...
COPY public.tenants (id, name, slug, contact_email, contact_phone, address, logo_url, primary_color, accent_color, timezone, language, is_active, created_at, updated_at, plan_code, public_api_key, public_api_enabled, website_enabled, website_domain, website_title, website_description, website_favicon_url, website_hero_image_url, website_about_text, website_footer_text, website_social_links, website_google_analytics_id, website_whatsapp_number, website_payment_provider, website_payment_api_key, website_payment_secret_key, website_languages, website_contact_page_title, website_contact_page_content, website_contact_email, website_contact_phone, website_contact_address, website_about_page_title, website_about_page_content, website_cancellation_page_title, website_cancellation_page_content, website_privacy_page_title, website_privacy_page_content, website_terms_page_title, website_terms_page_content, website_faq_page_title, website_faq_page_content, website_template_key, website_template_settings, website_footer_company_description, website_footer_payment_image_url, website_footer_copyright_text, website_footer_background_color, website_footer_text_color, website_header_background_color, website_header_text_color) FROM stdin;
2	Sky Fethiye	sky-fethiye	skyfethiye@gmail.com	05384944505	\N	\N	262 83% 58%	142 76% 36%	Europe/Istanbul	tr	t	2026-01-05 14:51:26.747834	2026-01-05 14:51:26.747834	trial	\N	f	f	\N	\N	\N	\N	\N	\N	\N	{}	\N	\N	\N	\N	\N	["tr"]	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	modern	{}	\N	\N	\N	\N	\N	\N	\N
8	Default Agency	default	admin@smartur.com	\N	\N	\N	262 83% 58%	142 76% 36%	Europe/Istanbul	tr	t	2026-01-06 14:41:58.125027	2026-01-06 14:41:58.125027	trial	\N	f	f	\N	\N	\N	\N	\N	\N	\N	{}	\N	\N	\N	\N	\N	["tr"]	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	modern	{}	\N	\N	\N	\N	\N	\N	\N
7	Acenta 1	acenta	acenta@acenta.com	5555555555			262 83% 58%	142 76% 36%	Europe/Istanbul	tr	t	2026-01-06 07:11:00.929471	2026-01-08 09:44:17.795	enterprise	\N	f	f	\N	\N	\N	\N	\N	\N	\N	{}	\N	\N	\N	\N	\N	["tr"]	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	modern	{}	\N	\N	\N	\N	\N	\N	\N
9	Acenta 2	acenta-2	acenta2@acenta.com	5555555555	\N	\N	262 83% 58%	142 76% 36%	Europe/Istanbul	tr	t	2026-01-08 10:06:57.725272	2026-01-08 10:06:57.725272	enterprise	\N	f	f	\N	\N	\N	\N	\N	\N	\N	{}	\N	\N	\N	\N	\N	["tr"]	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	modern	{}	\N	\N	\N	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.capacity_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.reservations_id_seq', 61, true);
...
SELECT pg_catalog.setval('public.settings_id_seq', 68, true);
...
--
-- Name: blog_posts blog_posts_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict SEn0FuaTzQn9WrssOztCPTljWfPagMGLzOWTWwIdZ99itxD88BTCYFleKPMoAA0
