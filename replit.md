...
## Son Değişiklikler
- 02.01.2026: Sidebar Uyelik Durumu - WooCommerce bilgisi kaldırıldı, yerine lisans durumu eklendi. Aktif lisanslarda kalan gün sayısı, süresi dolmuş lisanslarda "Yenileme Gerekli" gösterilir. Renk kodlaması: yeşil (>14 gün), sarı (7-14 gün), kırmızı (<7 gün veya süre dolmuş).
